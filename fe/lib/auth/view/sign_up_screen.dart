...
class SignUpScreen extends ConsumerWidget {
  ...
  Widget _infoForm(WidgetRef ref, SignUpFormModel form) {
    return Column(
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    final view = viewOrder == 0 ? _EmailValidForm() : _infoForm(ref, form);
          ...
          child: Visibility(
              ...
              child: Column(
                children: [
                  ...
                  DefaultTextButton(
                    onPressed: () {
                      ref.read(signUpViewProvider.notifier).update((v) => 1);
                    },
                    text: '인증하기',
                    able: form.validCode.length == 6,
                  ),
                  SizedBox(height: 20.h)
                ],
              )),
